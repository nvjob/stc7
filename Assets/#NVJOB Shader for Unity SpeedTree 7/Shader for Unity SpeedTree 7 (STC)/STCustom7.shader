...
Shader "#NVJOB/For SpeedTree 7/General" {
...
[MaterialEnum(Off,0,Front,1,Back,2)] _Cull("Backface Culling", Int) = 2
...
_Shininess("Shininess", Range(-1, 2)) = 0.078125
_Gloss("Gloss", Range(-1, 2)) = 1
...
_WindAmplitude("Wind Amplitude", Range(0.001, 10)) = 1
_WindDegreeSlope("Wind Degree Slope", Range(0.001, 10)) = 1
_WindConstantTilt("Wind Constant Tilt", Range(0.001, 10)) = 1
_LeafRipple("Leaf Ripple", Range(0.001, 100)) = 1
_LeafRippleSpeed("Leaf Ripple Speed", Range(0.001, 10)) = 1
_LeafTumble("Leaf Tumble", Range(0.001, 10)) = 1
_LeafTumbleSpeed("Leaf Tumble Speed", Range(0.001, 5)) = 1
_BranchRipple("Branch Ripple", Range(0.001, 20)) = 1
_BranchRippleSpeed("Branch Ripple Speed", Range(0.001, 10)) = 1
_BranchTwitch("Branch Twitch", Range(0.001, 10)) = 1
_BranchWhip("Elasticity", Range(0.01, 10)) = 1
_BranchTurbulences("Turbulences", Range(0.001, 10)) = 1
_BranchForceHeaviness("Branch Force Wind", Range(0.001, 10)) = 1

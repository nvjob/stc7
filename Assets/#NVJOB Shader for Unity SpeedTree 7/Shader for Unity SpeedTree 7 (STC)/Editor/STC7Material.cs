...
namespace UnityEditor
{
    ...
    internal class STC7Material : MaterialEditor
    {
        ...
        void Header()
        {
            ...
            EditorGUILayout.LabelField("#NVJOB Shader for SpeedTree 7 (v3.1)", guiStyle);
            DrawUILine(bgLineColor, 2, bgLinePadding);
        ...
        void Information()
        {
            ...
            DrawUILine(bgLineColor, 2, bgLinePadding);
            if (GUILayout.Button("Download Examples")) Help.BrowseURL("https://github.com/nvjob/stc7/archive/master.zip");
